 ...
 */
router.get("/", paginationValidation, verifyToken, adminOnly, getAllMembers);
/**
 * @swagger
 * /members/{id}:
 *   get:
 ...
 */
router.get("/:id", verifyToken, adminOnly, memberIdValidation, validate, getMemberById);
/**
 * @swagger
 * /members/{id}:
 *   put:
 ...
 *         description: Member tidak ditemukan
 */
router.put("/:id", verifyToken, adminOnly, updateMemberValidation, validate, updateMember);
/**
 * @swagger
 * /members/{id}:
 *   delete:
 ...
 *         description: Member tidak ditemukan
 */
router.delete("/:id", verifyToken, adminOnly, memberIdValidation, validate, deleteMember);
